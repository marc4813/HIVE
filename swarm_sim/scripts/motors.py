...
'''
This script was swiped from Wes Fletcher. I (Marc) copied it over to test the skid steering controller.  
'''
...
motor_pub = rospy.Publisher('agent1/cmd_vel', Twist, queue_size=100)  # creating publisher for topic /cmd_vel (that the robot subscribes to)
